...
"
# for some reason it wants automake-1.17
...
PATCHES=(
	...
	"${FILESDIR}"/0001_base_support_e2k.patch
	"${FILESDIR}"/${P}-e2k-support.patch
	"${FILESDIR}"/0002_resolve_e2k_syscall_names.patch
	"${FILESDIR}"/${P}-e2k-syscalls.patch
	"${FILESDIR}"/0003_readd_SCMP_ARCH_E2K_bruh.patch
)
