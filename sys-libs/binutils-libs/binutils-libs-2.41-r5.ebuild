...
SRC_URI="http://setwd.ws/sp/1.29/1.29.16/src/${MY_P}-${MCST_PV}.tar.xz
	https://setwd.ws/distfiles/${MY_PN}-mcst-${PATCH_BINUTILS_VER}-patches-${PATCH_VER}.tar.xz"
...
multilib_src_install() {
	...
	# a1ba: doesn't get installed anyway, removed die
	rm "${ED}"/usr/share/info/sframe-spec.info
