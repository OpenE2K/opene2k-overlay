...
PATCHES=(
	...
	# e2k port + crypto optimizations
	"${FILESDIR}"/0001_simple_e2k_port.patch
	"${FILESDIR}"/0002_tune_sha2.patch
	"${FILESDIR}"/0003_improving_big_numbers_on_e2kv5+.patch
	"${FILESDIR}"/0004_opt_gf2m_for_E2Kv6_only.patch
	"${FILESDIR}"/0005_opt_nist.patch
	"${FILESDIR}"/0008-using-e2kv7-ops-for-aes.patch
	"${FILESDIR}"/0009-Using-E2Kv6-clmul-ops-for-ghash-GCM.patch
	"${FILESDIR}"/0010-SIMD-optimization-of-chacha20-cipher.patch
	"${FILESDIR}"/0011-Using-new-E2Kv7-ops-for-AES-GCM-CTR-modes.patch
	"${FILESDIR}"/0012.Optimization-of-AES-GCM-CTR-modes-for-old-E2K-models.patch
	"${FILESDIR}"/0013-Preparing-to-AES+GCM-scratch-optimization.patch
	"${FILESDIR}"/0014-Hints-for-lcc-to-speed-up-the-RC4-cipher.patch
	"${FILESDIR}"/0015-E2Kv7-AESCTR+GHASH-stitch.patch
)
