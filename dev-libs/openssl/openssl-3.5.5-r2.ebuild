...
PATCHES=(
	...
	"${FILESDIR}"/0001-Configurations-Add-configurations-for-the-Elbrus2000.patch
	"${FILESDIR}"/0002-async_posix.c-Fix-calling-to-makecontext-on-Elbrus20.patch
	"${FILESDIR}"/0003-sha512.c-Tweaks-for-Elbrus2000-architecture.patch
	"${FILESDIR}"/0004-md32_common.h-Add-Elbrus2000-specific-version-of-ROT.patch
	"${FILESDIR}"/0005-Add-gf2m-specialization-for-Elbrus2000.patch
	"${FILESDIR}"/0006-bn_lib.c-Special-case-the-BN_num_bits_word-function-.patch
	"${FILESDIR}"/0007-Implement-the-BN-acceleration-for-Elbrus2000.patch
	"${FILESDIR}"/0008-Add-SIMD-specialization-of-chacha20-for-the-Elbrus20.patch
	"${FILESDIR}"/0009-GCM-ghash-specialization-for-the-e2kv6-Elbrus2000-ar.patch
	"${FILESDIR}"/0010-Add-hardware-accelerated-AES-implementation-for-the-.patch
)
