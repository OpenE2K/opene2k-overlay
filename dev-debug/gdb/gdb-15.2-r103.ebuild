...
case ${PV} in
	9999*)
		...
		;;
	*)
		EGIT_REPO_URI="https://github.com/OpenE2K/binutils-gdb.git"
		EGIT_BRANCH="gdb-15.2-mcst"
		EGIT_COMMIT="818fc87ba3397f5ce33f850d9ed76921bfc85702"
		inherit git-r3
		SRC_URI=""
		REGULAR_RELEASE=1
		;;
...
if [[ -n ${REGULAR_RELEASE} ]] ; then
	KEYWORDS="~e2k"
	[[ ${CATEGORY} == cross-* ]] && KEYWORDS="~amd64 ${KEYWORDS}"
fi
REQUIRED_USE="
